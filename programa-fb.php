...
<body id="page">
	...
	<div class="hv_page main-content" style="width: 100% !important; max-width: 820px !important; box-sizing: border-box; margin: auto; padding-top: 50px !important;background: none !important;">
		<div class="hv_fondo">
			
				
			<section class="hv_page_secc1 " style="max-width: 820px; ">
				
			 		<h1 class="title-header" style="text-align: center; margin: auto; padding-left: 0 !important;">
						PROGRAMA DE INGL&Eacute;S <span>PARA J&Oacute;VENES Y ADULTOS</span>
					</h1>
				<div class="content">
					<div class="page_content page2" style="display: none;">
					...
					<!--Formulario-->
					<section  class="sticky" style="width: 100% !important; max-width: 550px !important; margin: auto; padding-bottom: 50px;" >
						<div class="form_position">
						<div class="page2_form">
							
							<div id="button-form">
								<h2 id="title_form">¿Quieres m&aacute;s informaci&oacute;n?<br>Ingresa tus datos aqu&iacute;</h2>
								<div id="btn_show" style="display: none !important;"><img src="images/arrow-up.png"></div>
								<div class="cl"></div>
							</div>
							<div class="cl"></div>
							<form id="hvFormicpna">
								...
								<label class="label l">
									...
									<div class="form__select" style="height: 40px;">
										<strong>DNI</strong>
	...
	<script type="text/javascript" src="js/programa-jovenes_rv.js?rand=<?php echo date("Yhms"); ?>" ></script>
